...
mixin _$AppointmentModel implements DiagnosticableTreeMixin {
 ...
 String get service; DoctorModel get doctor; String get department; DateTime get dateAndTime; PatientModel get patient; AppointmentStatus get appointmentStatus;
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('service', service))..add(DiagnosticsProperty('doctor', doctor))..add(DiagnosticsProperty('department', department))..add(DiagnosticsProperty('dateAndTime', dateAndTime))..add(DiagnosticsProperty('patient', patient))..add(DiagnosticsProperty('appointmentStatus', appointmentStatus));
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AppointmentModel&&(identical(other.service, service) || other.service == service)&&(identical(other.doctor, doctor) || other.doctor == doctor)&&(identical(other.department, department) || other.department == department)&&(identical(other.dateAndTime, dateAndTime) || other.dateAndTime == dateAndTime)&&(identical(other.patient, patient) || other.patient == patient)&&(identical(other.appointmentStatus, appointmentStatus) || other.appointmentStatus == appointmentStatus));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,service,doctor,department,dateAndTime,patient,appointmentStatus);
...
@useResult
$Res call({
 String service, DoctorModel doctor, String department, DateTime dateAndTime, PatientModel patient, AppointmentStatus appointmentStatus
});
...
/// Create a copy of AppointmentModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? service = null,Object? doctor = null,Object? department = null,Object? dateAndTime = null,Object? patient = null,Object? appointmentStatus = null,}) {
...
as DoctorModel,department: null == department ? _self.department : department // ignore: cast_nullable_to_non_nullable
as String,dateAndTime: null == dateAndTime ? _self.dateAndTime : dateAndTime // ignore: cast_nullable_to_non_nullable
as DateTime,patient: null == patient ? _self.patient : patient // ignore: cast_nullable_to_non_nullable
as PatientModel,appointmentStatus: null == appointmentStatus ? _self.appointmentStatus : appointmentStatus // ignore: cast_nullable_to_non_nullable
...
class _AppointmentModel with DiagnosticableTreeMixin implements AppointmentModel {
   _AppointmentModel({required this.service, required this.doctor, required this.department, required this.dateAndTime, required this.patient, required this.appointmentStatus});
...
@override final  DateTime dateAndTime;
@override final  PatientModel patient;
@override final  AppointmentStatus appointmentStatus;
...
/// Create a copy of AppointmentModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? service = null,Object? doctor = null,Object? department = null,Object? dateAndTime = null,Object? patient = null,Object? appointmentStatus = null,}) {

...
abstract class $PharmacyModelCopyWith<$Res> {
  factory $PharmacyModelCopyWith(
    PharmacyModel value,
    $Res Function(PharmacyModel) then,
...
abstract class _$$PharmacyModelImplCopyWith<$Res>
  ...
  factory _$$PharmacyModelImplCopyWith(
    _$PharmacyModelImpl value,
    $Res Function(_$PharmacyModelImpl) then,
...
class __$$PharmacyModelImplCopyWithImpl<$Res>
  ...
  __$$PharmacyModelImplCopyWithImpl(
    _$PharmacyModelImpl _value,
    $Res Function(_$PharmacyModelImpl) _then,
  ) : super(_value, _then);
...
class _$PharmacyModelImpl implements _PharmacyModel {
  ...
  @override
  String toString() {
    return 'PharmacyModel(id: $id, name: $name, startTime: $startTime, finishTime: $finishTime, phone: $phone, latitude: $latitude, longitude: $longitude, location: $location)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$PharmacyModelImplToJson(this);
  }
}

abstract class _PharmacyModel implements PharmacyModel {
  factory _PharmacyModel({
    final int? id,
    final String? name,
